...
urlpatterns = [
    ...
    path('open-job/<int:job_id>/complete/', views.mark_open_job_complete, name='mark_open_job_complete'),
    path('open-job/<int:job_id>/verify/', views.verify_open_job_completion, name='verify_open_job_completion'),
